...
export function NumbersScreen({ email, onSair }: NumbersScreenProps) {
    ...
    <div className={styles.tela}>
      <header className={styles.topo}>
        ...
        <nav className={styles.abas} aria-label="Painel">
          <span className={styles.abaAtiva} aria-current="page">
            Números
          </span>
          <span className={styles.abaEmBreve}>
            Moderação <span className={styles.emBreve}>em breve</span>
          </span>
        </nav>
